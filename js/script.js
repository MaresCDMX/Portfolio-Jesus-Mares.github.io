window.addEventListener("load", () => {
  ...
  /* ----- Page Loader ----- */
  document.querySelector(".page-loader").classList.add("fade-outss");
  setTimeout(() => {
...
function hideSection() {
  document.querySelector("section.active").classList.toggle("fade-outs");
}
  ...
  if (e.target.classList.contains("link-item") && e.target.hash !== "") {
    ...
    setTimeout(() => {
      document
        ...
        .classList.remove("active", "fade-outs");
